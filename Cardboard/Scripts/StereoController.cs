...
public class StereoController : MonoBehaviour
{
	...
	//Vector3 for scalling of ingame menu
	Vector3 ingamemenu_scale = new Vector3 (0.05f, 0.05f, 0.05f);
	bool ingamemenu_expand = true;
