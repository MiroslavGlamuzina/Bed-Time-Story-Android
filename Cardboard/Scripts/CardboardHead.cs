...
public class CardboardHead : MonoBehaviour {
  ...
  public bool updateEarly = false;
	...
	//reset the position on start
	void Start(){
		Quaternion reset = new Quaternion (0f,0f,0f,0f);
  ...
  void Update() {
    ...
    if (updateEarly) {
      UpdateHead();
			//CameraToPlayerReference();
    }
  }

	void CameraToPlayerReference()
	{
		if (player.transform.localRotation == this.transform.rotation) {
